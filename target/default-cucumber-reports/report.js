...
formatter.match({
  "location": "PosStepDefenitions.user_logs_in_as_Pos_manager()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "PosStepDefenitions.user_navigates_to_Pos_Module()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "PosStepDefenitions.verify_that_page_limit_is(Integer)"
});
formatter.result({
  "status": "passed"
});
